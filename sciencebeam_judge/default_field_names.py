...
class BodyFieldNames:
    ...
    FIRST_BODY_SECTION_PARAGRAPHS = 'first_body_section_paragraphs'
...
class BackFieldNames:
    ...
    FIRST_BACK_SECTION_PARAGRAPHS = 'first_back_section_paragraphs'
...
class BodyBackSectionFieldNames:
    ...
    FIRST_ALL_SECTION_PARAGRAPHS = 'first_all_section_paragraphs'
